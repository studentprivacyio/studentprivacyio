...
I, ${parentName}, as the parent/legal guardian of ${studentName}, am writing to exercise my rights under the Children's Online Privacy Protection Act (COPPA) regarding the use of ${isMultiple ? 'the following software tools' : 'this software'}: ${softwareListText}.
