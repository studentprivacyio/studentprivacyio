...
<Note type="warning" class='mb-4'>This is not legal advice nor anything similar. Do not rely on this information. Quite a bit of this info might be wrong, especially parts that are still under construction. Please double check all information before using it.</Note>
...
<br/> {/*this is a hack to fix formatting issues*/}
